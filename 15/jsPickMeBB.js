...
$(document).ready(function(){
    ...
    function c(){
        $("#idOne").css("border","3px solid black");
        $("#idFive").css("border","3px solid black");
        $("#idSix").css("border","3px solid black");
        $("#idTen").css("border","3px solid black");
    }
    ...
    function f(){
        $(".two:first").css("border","3px solid green");
        $(".four:first").css("border","3px solid green");
        $(".seven:first").css("border","3px solid green");
        $(".nine:first").css("border","3px solid green");
    }
