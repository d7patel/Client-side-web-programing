...
$(document).ready(function(){// start document.ready
	...
	// hide output until user click submit button.
	$("#myOutpt").hide();

	$(".ddd").addClass('seasonal');
...
$( "#dialog-link, #icons li" ).hover(
	...
	$.validator.setDefaults({
		...
		//Header
		// creating the variables for output
		...
		//creating new variables for final output lines
		...
		outPut.innerHTML = "<h3>Login Info:<br></h3>"+print1+print2+print3+print4+print5+strGreeting+"<h3>Sign Up Info:</br></h3>"+print6+print7+print8+print9+print10+print11+print12+print13+print14+print15+print16+print17+print18;
    ...
    $("#target").validate({ignore:[], //rule to not ignore the hidden field
		...
		messages: {//Custom validation message
			...
			msg:"Please Add A Comments",
			spinner:"Please Give Us A Stars From 0 to 5",
			...
			zip:{
				...
				rangelength:"Please Enter The Valid Zipcode"
			},
			email1:{
				required: "Please Enter The Email",
				email: "Your email address must be in the format of username@domain.com"
